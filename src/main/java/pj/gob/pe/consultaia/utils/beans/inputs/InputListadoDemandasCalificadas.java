...
@Schema(description = "Filtros opcionales para el listado de demandas calificadas. El userId se obtiene de la sesión.")
@Data
@AllArgsConstructor
@NoArgsConstructor
public class InputListadoDemandasCalificadas {
