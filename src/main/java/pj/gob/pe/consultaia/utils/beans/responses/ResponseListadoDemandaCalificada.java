...
@Schema(description = "Item del listado de demandas calificadas (sin el texto completo de la calificación)")
@Data
@AllArgsConstructor
@NoArgsConstructor
public class ResponseListadoDemandaCalificada {

    @Schema(description = "ID de la demanda calificada", example = "1")
    private Long id;
    ...
    public static ResponseListadoDemandaCalificada fromEntity(DemandasCalificadas d) {
        ResponseListadoDemandaCalificada r = new ResponseListadoDemandaCalificada();
        r.setId(d.getId());
