...
@Schema(description = "Entidad que representa la tabla DemandasSentencias")
@Entity
@Table(name = "DemandasSentencias")
...
public class DemandasSentencias {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Schema(description = "ID único de la sentencia generada", example = "1")
    private Long id;
