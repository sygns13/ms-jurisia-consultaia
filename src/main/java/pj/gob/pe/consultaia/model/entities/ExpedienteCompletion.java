...
@Schema(description = "Entidad que representa la tabla Expediente Completions")
@Entity
@Table(name = "ExpedienteCompletions")
...
public class ExpedienteCompletion {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Schema(description = "ID único de la finalización", example = "1")
    private Long id;
    ...
    @Column(name = "roleContent", columnDefinition = "TEXT")
